...
++(0,3) node[sideannotL] (cohort) {cohort}
% read count ratio
...
% read count ratios
\path
(g1g1start|-S) -- node[annot] {\(\frac{13 + 9}{14 + 11} = 0.88\)} (g1g1end|-S) 
(g1g2start|-S) -- node[annot] {\(\frac{6}{11} \approx 0.55\)} (g1g2end|-S) 
;


% DRAW GENOME 2
% molecules/seqmences
\DNAgenometwo{matDNA}{(matDNA)}{ref}{ref}{ref}{ref}
\DNAgenometwo{patDNA}{(patDNA)}{ref}{ref}{alt}{alt}
\DNAgenometwo{DNA}{(RNAseq)}{ref}{ref}{ref}{ref}
\matRNAgenometwo{(matRNA)}{ref}{ref}{ref}{alt}{8}{4}
\patRNAgenometwo{(patRNA)}{alt}{ref}{ref}{ref}{4}{3}
...
% read count ratios
\path
(g2g1start|-S) -- node[annot] {\(\frac{7 + 3}{10 + 5} \approx 0.67\)} (g2g1end|-S) 
(g2g2start|-S) -- node[annot] {\(\frac{4}{6} \approx 0.67\)} (g2g2end|-S) 
;
